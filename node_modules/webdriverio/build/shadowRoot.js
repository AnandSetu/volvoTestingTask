...
export class ShadowRootManager {
    ...
    handleLogEntry(log) {
        ...
        if (eventType === 'newShadowRoot' && args[2].type === 'node' && args[3].type === 'node') {
            ...
            this.#shadowRootElements.set(args[2].sharedId, args[3].sharedId);
            return;
        }
     ...
     */
    getShadowRootsForContext(context) {
